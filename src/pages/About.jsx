    ...
    <div className="bg-[#FFFFFF] text-[#181818] min-h-screen space-y-16 pb-0">
      ...
      <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 pt-4">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="space-y-4 text-xs font-sans text-neutral-500 leading-relaxed text-justify">
            <p>
        ...
        <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Card 1 */}
          <div className="bg-white border border-[#ECECEC] flex flex-col justify-between h-full shadow-sm">
            ...
            <div className="p-4 space-y-2 border-t">
              <div className="flex gap-2 items-center">
                <div className="w-7 h-7 rounded bg-[#0B251A] flex items-center justify-center text-[#D9C7A3] shrink-0">
                  <Star className="w-3.5 h-3.5" />
                </div>
                <h4 className="text-[10px] tracking-wider font-sans font-bold uppercase text-neutral-700">
      ...
      <section className="max-w-7xl mx-auto px-6">
        <div className="bg-[#F8F6F2] border border-[#ECECEC] p-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          <div className="flex items-center justify-center gap-4 py-2">
            <span className="text-3xl font-serif font-light text-[#B68D40] shrink-0">10K+</span>
            <div className="text-left space-y-0.5">
              <h4 className="text-[9.5px] tracking-widest font-sans font-bold text-neutral-700 uppercase">HAPPY CUSTOMERS</h4>
              <p className="text-[9px] font-sans text-neutral-400">Personalised wardrobe service</p>
            </div>
          </div>
          <div className="flex items-center justify-center gap-4 py-2 divide-x-0 md:divide-x divide-neutral-200">
            ...
            <div className="text-left space-y-0.5 pl-4">
              <h4 className="text-[9.5px] tracking-widest font-sans font-bold text-neutral-700 uppercase">UNIQUE DESIGNS</h4>
              <p className="text-[9px] font-sans text-neutral-400">Couture silhouettes created</p>
            </div>
          </div>
          <div className="flex items-center justify-center gap-4 py-2 divide-x-0 md:divide-x divide-neutral-200">
            <span className="text-3xl font-serif font-light text-[#B68D40] shrink-0 md:pl-6">50+</span>
            <div className="text-left space-y-0.5 pl-4">
              <h4 className="text-[9.5px] tracking-widest font-sans font-bold text-neutral-700 uppercase">SKILLED ARTISANS</h4>
              <p className="text-[9px] font-sans text-neutral-400">Preserving heritage pit looms</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 pt-4">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="space-y-5">
            ...
            <div className="flex gap-4 items-start">
              <div className="w-9 h-9 rounded bg-[#0B251A] flex items-center justify-center text-[#D9C7A3] shrink-0">
                <Scissors className="w-4 h-4" />
              </div>
              <div className="space-y-0.5">
                <h4 className="text-[10px] tracking-widest font-sans font-bold text-neutral-700 uppercase">CUSTOM MADE</h4>
                <p className="text-[9.5px] font-sans text-neutral-400 leading-relaxed">
            ...
            <div className="flex gap-4 items-start">
              ...
              <div className="space-y-0.5">
                <h4 className="text-[10px] tracking-widest font-sans font-bold text-neutral-700 uppercase">ETHICAL & SUSTAINABLE</h4>
                <p className="text-[9.5px] font-sans text-neutral-400 leading-relaxed">
            ...
            <div className="flex gap-4 items-start">
              ...
              <div className="space-y-0.5">
                <h4 className="text-[10px] tracking-widest font-sans font-bold text-neutral-700 uppercase">TRANSPARENT PRICING</h4>
                <p className="text-[9.5px] font-sans text-neutral-400 leading-relaxed">
            ...
            <div className="flex gap-4 items-start">
              ...
              <div className="space-y-0.5">
                <h4 className="text-[10px] tracking-widest font-sans font-bold text-neutral-700 uppercase">SECURE SHOPPING</h4>
                <p className="text-[9.5px] font-sans text-neutral-400 leading-relaxed">
        ...
        <div className="lg:col-span-6 bg-white border border-[#ECECEC] p-6 grid grid-cols-1 md:grid-cols-2 gap-6 shadow-sm">
          <div className="space-y-4 flex flex-col justify-between">
            ...
            <div className="space-y-2 text-[10px] font-sans text-neutral-500">
            ...
            <div>
              <button
                ...
                className="w-full bg-[#0B251A] hover:bg-[#B68D40] text-[#D9C7A3] hover:text-white border border-[#B68D40] py-3.5 text-[9.5px] font-sans font-bold tracking-widest uppercase transition-colors flex items-center justify-center gap-1.5"
              >
          ...
          <div className="aspect-[1.1/1] w-full bg-neutral-100 overflow-hidden border">
            <img
      ...
      {/* SECTION 5: DARK GREEN QUOTATION AT THE BOTTOM */}
